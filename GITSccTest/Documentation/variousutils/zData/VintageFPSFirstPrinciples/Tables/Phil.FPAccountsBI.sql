...
/****** Object:  Table [Phil].[FPAccountsBI]    Script Date: 19/04/2016 18:18:33 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [Phil].[FPAccountsBI](
	[pkFPAccountsBI] [int] IDENTITY(1,1) NOT NULL,
 ...
 CONSTRAINT [PK_pkFPAccountsBI] PRIMARY KEY CLUSTERED 
(
	[pkFPAccountsBI] ASC
